...
class TaskService
{
    ...
    {
        return Post::with('project')->where('project_id', $projectId)
            ->orderBy('priority')->get();
    }

    public function getById(int $id)
    {
        return Post::where('id', $id)->with('project')->first();
    }

    public function store($data): void
    {
        $count = Post::where('project_id', $data['project_id'])->count();
    ...
    public function delete(int $id): void
    {
        ...
        $tasks = Post::where('project_id', $task->project_id)
    ...
    {
        $items = Post::where('project_id', $project_id)
